...
export const siteConfig: SiteConfig = {
	title: "mzyxsl-blog",
	subtitle: "写什么好呢",
	description: "mzyxsl的个人网站，随时分享一些实用的东西。",
	keywords: [ "mzyxsl", "名字已消失了", ],
...
export const navBarConfig: NavBarConfig = {
	links: [
		...
		{
			name: "GitHub",
			url: "https://github.com/mzyxsl/mzyxsl.github.io", // Internal links should not include the base path, as it is automatically added
	...
	links: [
		{
			...
			url: "https://t.me/mzyxsl114514",
		},
		{
			name: "bilbili",
			icon: "fa6-brands:bilibili",
			url: "https://space.bilibili.com/49827389",
		},
		{
			name: "email",
			icon: "fa6-regular:envelope",
			url: "mailto:mzyxsl@mzyxsl.com",
		},
		{
			name: "GitHub",
			icon: "fa6-brands:github",
			url: "https://github.com/mzyxsl",
		},
	],
};
